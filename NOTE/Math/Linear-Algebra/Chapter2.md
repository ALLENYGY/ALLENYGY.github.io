...
##  1. <a name='Chapter2LinearTransformations'></a>Chapter 2  Linear Transformations
...
𝐿𝑖𝑛𝑒𝑎𝑟 𝑜𝑝𝑒𝑟𝑎𝑡𝑜𝑟 ⊂ 𝑙𝑖𝑛𝑒𝑎𝑟 𝑡𝑟𝑎𝑛𝑠𝑓𝑜𝑟𝑚𝑎𝑡𝑖𝑜𝑛 
 $$𝐿:𝑉→𝑉  \subset  𝐿:𝑉→𝑊$$ 
####  1.1.3. <a name='LinearTransformationsfromto'></a>Linear Transformations from $ℝ^𝑛$ to $ℝ^𝑚$
* Definition:
...
####  1.1.7. <a name='Theorem2.1.1KernelImagearesubspaces'></a>Theorem 2.1.1 (Kernel/Image are subspaces)
