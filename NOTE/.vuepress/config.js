    ...
    group: {
      ...
      Math: [
        ...
        },
        {
          text: "离散数学",
          sublink: [
            { text: "Logic and Proofs----Propositional Logic", link: "Math/Lecture/DiscreteStructure/Lec1" },
            { text: "Logic and Proofs- Propositional Equivalence", link: "Math/Lecture/DiscreteStructure/Lec2" },
            { text: "Sets and N-tuple", link: "Math/Lecture/DiscreteStructure/Lec5" },
            { text: "Functions, Sequence, and Summations", link: "Math/Lecture/DiscreteStructure/Lec6" },
            { text: "Counting-Principles", link: "Math/Lecture/DiscreteStructure/Lec7" },
            { text: "Relation", link: "Math/Lecture/DiscreteStructure/Lec10" },
            { text: "Graph Theory", link: "Math/Lecture/DiscreteStructure/Lec11" },
            { text: "Graph Theory- Representing graph and connectivity", link: "Math/Lecture/DiscreteStructure/Lec12" },
            { text: "Tree", link: "Math/Lecture/DiscreteStructure/Lec13" },
            { text: "Boolean Algebras- Boolean Expressions", link: "Math/Lecture/DiscreteStructure/Lec14" },
            { text: "Boolean Algebras- Logic Circuits", link: "Math/Lecture/DiscreteStructure/Lec15" },            
          ],
        },
        {
          text: "概率统计",
