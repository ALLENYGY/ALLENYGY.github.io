    ...
    group: {
      ...
      Math: [
        ...
        },
        {
          text: "离散数学",
          sublink: [
            { text: "Logic and Proofs----Propositional Logic", link: "Math/DiscreteStructure/Lec1" },
            { text: "Logic and Proofs- Propositional Equivalence", link: "Math/DiscreteStructure/Lec2" },
            { text: "Sets and N-tuple", link: "Math/DiscreteStructure/Lec5" },
            { text: "Functions, Sequence, and Summations", link: "Math/DiscreteStructure/Lec6" },
            { text: "Counting-Principles", link: "Math/DiscreteStructure/Lec7" },
            { text: "Relation", link: "Math/DiscreteStructure/Lec10" },
            { text: "Graph Theory", link: "Math/DiscreteStructure/Lec11" },
            { text: "Graph Theory- Representing graph and connectivity", link: "Math/DiscreteStructure/Lec12" },
            { text: "Tree", link: "Math/DiscreteStructure/Lec13" },
            { text: "Boolean Algebras- Boolean Expressions", link: "Math/DiscreteStructure/Lec14" },
            { text: "Boolean Algebras- Logic Circuits", link: "Math/DiscreteStructure/Lec15" },            
          ],
        },
        {
          text: "概率统计",
