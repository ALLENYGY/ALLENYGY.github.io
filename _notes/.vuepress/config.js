...
module.exports = {
  ...
  themeConfig: {
    ...
    nav: {
      ...
      数据库: {
        ...
        MySQL: {
          ...
          "Set Operation & WHERE subquery": "DBM/MySQL/Lab8",
          "Division and Correlated Subquery": "DBM/MySQL/Lab9",
          "Advanced SQL": "DBM/MySQL/Lab10",
        },
      },
      // "DBM",
      数据分析: "DataAnalysis",
    ...
    group: {
      ...
      Math: [
        ...
        },
        {
          text: "离散数学",
          sublink: [
            { text: "Logic and Proofs----Propositional Logic", link: "Math/DiscreteStructure/Lecture/Lec1" },
            { text: "Logic and Proofs- Propositional Equivalence", link: "Math/DiscreteStructure/Lecture/Lec2" },
            { text: "Sets and N-tuple", link: "Math/DiscreteStructure/Lecture/Lec5" },
            { text: "Functions, Sequence, and Summations", link: "Math/DiscreteStructure/Lecture/Lec6" },
            { text: "Counting-Principles", link: "Math/DiscreteStructure/Lecture/Lec7" },
            { text: "Relation", link: "Math/DiscreteStructure/Lecture/Lec10" },
            { text: "Graph Theory", link: "Math/DiscreteStructure/Lecture/Lec11" },
            { text: "Graph Theory- Representing graph and connectivity", link: "Math/DiscreteStructure/Lecture/Lec12" },
            { text: "Tree", link: "Math/DiscreteStructure/Lecture/Lec13" },
            { text: "Boolean Algebras- Boolean Expressions", link: "Math/DiscreteStructure/Lecture/Lec14" },
            { text: "Boolean Algebras- Logic Circuits", link: "Math/DiscreteStructure/Lecture/Lec15" },            
          ],
        },
        {
          text: "概率统计",
    ...
    card_group: [
      ...
      {
        img_url: "https://cdn.jsdelivr.net/gh/open17/Pic/img/202402031524062.webp",
        title: "OPEN17的个人小站",
        description: "友链: open17的个人博客",
